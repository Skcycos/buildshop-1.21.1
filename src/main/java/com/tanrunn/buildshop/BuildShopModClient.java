...
public class BuildShopModClient {
    ...
    static void onClientSetup(FMLClientSetupEvent event) {
        // Backend implementations are loaded reflectively so either optional UI library can be
        // omitted from a client without causing a class-loading failure.
        event.enqueueWork(com.tanrunn.buildshop.client.UiBackendManager.INSTANCE::initialize);
